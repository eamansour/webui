...
const CLIENT_API_VERSION = '0.48.1';
...
const TEST_RUN_PAGE_TABS = [
  TEST_RUN_TAB_NAMES.OVERVIEW,
  TEST_RUN_TAB_NAMES.METHODS,
  TEST_RUN_TAB_NAMES.RUN_LOG,
  TEST_RUN_TAB_NAMES.ARTIFACTS,
  TEST_RUN_TAB_NAMES.ZOS3270,
];
